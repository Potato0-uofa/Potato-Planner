...
/**
 * Instrumented tests for InvitationsActivity (Notifications screen).
 * Verifies the notifications screen loads and UI elements are present.
 */
@RunWith(AndroidJUnit4.class)
public class InvitationsActivityTest {

    @Rule
    public ActivityScenarioRule<InvitationsActivity> scenario =
            new ActivityScenarioRule<>(InvitationsActivity.class);
